// ---------------------------------------------------------------------------------------------------------------------------------------
// <copyright file="StringToNumberConverter.to-int.cs" company="Trencadis">
...
namespace Trencadis.Core.Conversions.SpecializedConversions.StringConverters
{
	...
	/// <summary>
	/// Specialized class for conversions from string to int
	/// </summary>
	public class StringToIntConverter : StringToNumberConverter<int>
	{
		/// <summary>
		/// Tries to parse the specified string and convert it to int
		/// </summary>
		...
		protected override bool TryParseNumber(string input, NumberStyles style, IFormatProvider format, out int result)
		{
			return int.TryParse(input, style, format, out result);
		}
	}
}
